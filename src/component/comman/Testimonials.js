...
<div className=" mt-5">
<h3 className="headingstyle ">Students Testimonials</h3>
...
<div className="wrapper  widt">
          ...
          <img src={require('../../asset/istockphoto-1139495117-612x612 1.png')} className="imgper1"></img>
          </div>
          <div className="description">
            <p className="mt-3">Learning at Parul University has provided 
